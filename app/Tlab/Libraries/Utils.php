...
static function getVarType($var){
 ...
 * @param int $default
 */
static function ValidateInt($value, $default = NULL){
 ...
 * @return float
 */
static function ValidateFloat($value, $default = NULL){
 ...
 */
static function formatDateDM($date){
...
static function formatDateRFC822($date){
...
static function diffDateTime($dtime1, $dtime2){
 ...
 */
static function curlHTTPCopy($url_from, $path_to){
 ...
 */
static function crop2fit($source_path, $cache_path, $desired_width = 150, $desired_height = 150){
...
static function seoUrlDecode($url){
...
static function friendly_url($url) {
...
static function replace_accents($var){ //replace for accents catalan spanish and more
